...
lmap("n", "fg", "<Cmd>Telescope live_grep<cr>", "Live Grep")
lmap("n", "fc", "<Cmd>Telescope grep_string<cr>", "Find Word")
...
vim.keymap.set("n", "<leader>fn", function() require("telescope.builtin").find_files({cwd = "~/notes"}) end, { desc = "Notes" })
...
vim.keymap.set("n", "<leader>qa", AddToQuickfix, { desc = "Add Current Line" })
vim.keymap.set("n", "<leader>qo", "<cmd>copen<cr>", { desc = "Open" })
vim.keymap.set("n", "<leader>qc", "<cmd>cclose<cr>", { desc = "Close" })
vim.keymap.set("n", "<leader>qC", ClearQuickfix, { desc = "Clear" })
vim.keymap.set("n", "<leader>qs", SaveQuickfix, { desc = "Save" })
